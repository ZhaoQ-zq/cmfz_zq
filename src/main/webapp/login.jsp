    ...
    <script>
        $(function () {
            $("#captchaImage").click(function () {
                $("#captchaImage").attr("src","${pageContext.request.contextPath}/admin/code?time"+new Date());
            })
        })
    </script>
    <style>
        body{
            background: url("${pageContext.request.contextPath}/assets/img/backgrounds/1.jpg");
        }
    </style>
</head>
                ...
                <div class="col-sm-6 col-sm-offset-3 form-box">
                    ...
                    <div class="form-bottom" style="width: 450px">
                        ...
                        <form role="form" action="${pageContext.request.contextPath}/admin/login" method="post"
                            ...
                            <div class="form-group">
                                <img id="captchaImage" style="height: 38px" class="captchaImage" src="${pageContext.request.contextPath}/admin/code">
